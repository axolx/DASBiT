 ...
 */
class AutoJoinPlugin extends DASBiT_Controller_Plugin_Abstract
{    
    /**
    ...
    public function postConnect()
    {
        ...
        $channels = $channelsModel->fetchAll();
        foreach ($channels as $channel) {           
            $response->sendRaw('JOIN ' . $channel->channel_name);
            DASBiT_Controller_Front::getInstance()->getLogger()->log('Joined ' . $channel->channel_name);
        }
    }
}